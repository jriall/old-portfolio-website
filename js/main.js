...
$(document).ready(function() {
  ...
  $(window).scroll(function() {
    ...
    for (var i = 0; i < sectionPosition.length; i++) {
      if (
        ...
        $(document).scrollTop() <
          $(sectionPosition[i]).offset().top +
            $(sectionPosition[i]).height() -
            500
      ) {
        $(
    ...
    for (var j = 0; j < fadePosition.length; j++) {
      ...
      if (
        ...
        $(document).scrollTop() <
          $(fadePosition[j]).offset().top + $(fadePosition[j]).height() - 500
      ) {
  ...
  $(".cover-page").backstretch(
    ["images/indonesia.jpg", "images/fog.jpg", "images/south-tyrol.jpg"],
